...
const uuid = '732185c4-c595-47cc-92b6-9c2e17791f70';
const passWordSha224 = '3e04a413d85722c77de1911b23ee44031119475b47fa8cc5ed203ed3';
const bufferSize = 512 * 1024;
const startThreshold = 50 * 1024 * 1024;
const maxChunkLen = 64 * 1024;
const flushTime = 20;
const proxyStrategyOrder = ['socks', 'http'];
const proxyIpAddrs = {EU: 'eu.proxy.622723.xyz', AS: 'sg.proxy.622723.xyz', JP: 'jp.proxy.622723.xyz', US: 'us.proxy.622723.xyz'};
const coloRegions = {
...
const handleWebSocketConn = async (webSocket, request) => {
    ...
    let tcpWrite, parsedRequest, tcpSocket;
